		...
		echo '	<div>							</div>
										...
										<tr>	
											<td id = "tblwidth">
												...
												<h3> Help others know about this place, share youre experience now!</h3>
												</div>
											</td>
										</tr>
										';
			...
			<div class="modal-dialog">
				<div class="modal-content" >
					...
					<div class=" row modal-body text-center">
						<form action="<?php echo base_url ('Pilipinas/rating')?>" method="POST">
							<div id="first" style="display:inline-block; width:8%;" >
								<div id="a" style="display:block; position: relative;">
									<button onload = "one()" onclick ="one()" type="button"  style="  border: none; cursor:pointer; position: relative; width:100%; background-color: Transparent; background-repeat:no-repeat; border: none; cursor:pointer;">
