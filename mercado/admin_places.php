									...
									foreach($places as $n){
										...
										<tr>	
											...
											<td id = "tbl_actions">
												...
												<a class="btn btn-danger" data-toggle="modal" data-target="#editplace" style="cursor: pointer;"><span class="glyphicon glyphicon-trash"></span></a>
												
												<a class="btn btn-default" style="cursor: pointer;" href="';  echo base_url('Pilipinas/editplace'); echo '?place_id='.$n['place_id']; echo '"><span class="glyphicon glyphicon-pencil"></span></a>
