...
<div class = "container-fluid" style = "background-image: url('img/background')">	
	...
	<div  class = "row text-center" >
		...
		<div id = "travel" class = "col-xs-2" >
			<a href =" <?php echo base_url('Pilipinas/travel/'); echo '?category=0'; echo '&viewtype=0';?>"> <img src="<?php echo base_url('img/0.png') ?>" style = "width: 40%" alt="" > </a>
		</div>

		<div  id = "travel" class = "col-xs-2">
		<a href =" <?php echo base_url('Pilipinas/travel/'); echo '?category=1'; echo '&viewtype=0';  ?>"> <img src="<?php echo base_url('img/1.png') ?>" style = "width: 40%" alt="" > </a>
		</div>
		<div id = "travel" class = "col-xs-2">
		<a href =" <?php echo base_url('Pilipinas/travel/'); echo '?category=2'; echo '&viewtype=0'; ?>"> <img src="<?php echo base_url('img/2.png') ?>" style = "width: 40%" alt=""> </a>
		</div>
		<div id = "travel"  class = "col-xs-2">
		<a href =" <?php echo base_url('Pilipinas/travel/'); echo '?category=3'; echo '&viewtype=0'; ?>"> <img src="<?php echo base_url('img/3.png') ?>" style = "width: 50%" alt="" > </a>
		</div>
		<div id = "travel" class = "col-xs-2">
		<a href =" <?php echo base_url('Pilipinas/travel/'); echo '?category=4'; echo '&viewtype=0'; ?>"> <img src="<?php echo base_url('img/4.png') ?>" style = "width: 40%" alt="" > </a>
		</div>	
		<div class = "col-xs-1"></div>
    </div>
	<div  class = "row text-center" >
				...
				if(isset($_GET['category'])){
					...
					if($view == "grid"){	
						...
						<div class = "row" style ="padding-bottom: 20px;">
								...
								<div class = "col-md-5">
								<br/>
								<h2 > &nbsp; &nbsp; &nbsp;&nbsp; List of All ';echo $label; echo' </h2>
								</div>
								<div class = "col-md-4">
						...
						foreach ($places as $n){
							echo '
							<li class = "text-left">
								<a class="rig-cell" href="'; echo base_url('Pilipinas/details'); echo '?place_id='.$n['place_id']; echo' " target="_blank">
									<div class="thumbnail">
