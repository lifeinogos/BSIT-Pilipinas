	...
	<div class = "row text-left" id = "admin_place">
		...
		<div class = "col-md-10"> 
			...
			<div class = "row" >	
				...
				<a class="btn btn-default"  href="<?php echo base_url('Pilipinas/reviews');?>"  style="cursor: pointer;"><span class="glyphicon glyphicon-repeat"></span>  Refresh list</a>
			</div>
										...
										foreach($review as $n){
											...
											<tr>	
												...
												<td id = "tbl_actions">
													...
													<button class = "btn btn-danger" type = "submit" name = "treview_id" value = "'; echo $n['treview_id']; echo '" ><span  class="glyphicon glyphicon-trash"></span></button>
													
													</form>
													<form action = "'; echo base_url('Pilipinas/add_pending'); echo'" method = "POST">
													<button  class = "btn btn-success" type = "submit" name = "treview_id" value = "'; echo $n['treview_id']; echo '"><span  class="glyphicon glyphicon-ok"></span></button>
