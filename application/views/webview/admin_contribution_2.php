...
<div class = "container-fluid" style = "background-image: url('img/background');">	
	...
	<div class = "row text-left" id = "admin_place">
		...
		<div class = "col-md-10"> 
			<span = "glyphicon glyphicon-picture"></span><h1> List of Approved Photo Contributions</h1>
			<?php
				if($contributions != 'No approved contributions' ){
					echo '<h4> Total approved contributions from visitors: '; echo $count; echo '  <h4>';
				}
			?>
			<div class = "row" >	
				<a class="btn btn-default"  href="<?php echo base_url('Pilipinas/contributions_1_views/');?>"  style="cursor: pointer;"><span class="glyphicon glyphicon-list-alt"></span>Click to Manage Pending Contributions</a>
				<a class="btn btn-default"  href="<?php echo base_url('Pilipinas/contributions_2_views/');?>"  style="cursor: pointer;"><span class="glyphicon glyphicon-repeat"></span>  Refresh list</a>
			</div>
							...
							<?php
									if($contributions!= 'No approved contributions'){
										...
										foreach($contributions as $n){
											echo '
											<tr>	
												<td id = "tbl_id">'; echo $n['contribution_id']; echo '</td>
												...
												<td id = "tbl_actions">
														<form action = "'; echo base_url('Pilipinas/delete_approved_contribution'); echo'" method = "POST">
														<button class = "btn btn-danger glyphicon glyphicon-trash" type = "submit" name = "contribution_id" value = "'; echo $n['contribution_id']; echo '><span  class=""></span></button>
														</form>
										...
										echo '
										<h2> Refresh, there is no approved photo contributions right now</h2>
										';
									}
