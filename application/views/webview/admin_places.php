	 ...
	 <nav class="navbar navbar-custom navbar-fixed-top text-center">
			...
			<div  class="collapse navbar-collapse" id="myNavbar">		
				<ul class="nav navbar-nav">
							...
							<li   style = "border-radius: 0px 30px 0px 30px; background-color: gray;"><a href="<?php echo base_url('Pilipinas/places/');?>"> Places	</a></li>			
...
<div class = "container-fluid" style = "background-image: url('img/background');">	
	...
	<div class = "row" >
		...
		<div class = "col-md-10">
			<h1> List of all places in the Database</h1>
			<table id="customers">
						<thead>
							<th> NO.</th>
							<th> NAME</th>
