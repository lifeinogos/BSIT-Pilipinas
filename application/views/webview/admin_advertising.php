	 ...
	 <nav class="navbar navbar-custom navbar-fixed-top text-center">
			...
			<div  class="collapse navbar-collapse" id="myNavbar">		
				<ul class="nav navbar-nav">
							...
							<li ><a href="<?php echo base_url('Pilipinas/request/');?>"> Request </a></li>
							<li><a href="<?php echo base_url('Pilipinas/clients/');?>"> Clients </a></li>
							<li><a href="<?php echo base_url('Pilipinas/places/');?>"> Places	</a></li>			
							<li  style = "border-radius: 0px 30px 0px 30px; background-color: gray;" ><a href="<?php echo base_url('Pilipinas/advertising/');?>"> Advertising	</a></li>			
							<li><a href="<?php echo base_url('Pilipinas');?>"> Logout	</a></li>			
							<li> <h2> ADMINISTRATOR </h2>	</a></li>			
			    </ul> 		   
			</div>
...
<div class = "container-fluid" style = "background-image: url('img/background');">	
	...
	<div class = "row" >
		...
		<div class = "col-md-10">
			<h1> List of current allowed advertisment</h1>
			<table id="customers">
						<thead>
							<th> NO.</th>
							<th> CLIENT NAME</th>
