...
<!-- main pic for travel -->
			...
			<br />
				  ...
				  <div class="item">
					<img src="<?php echo base_url('img/slider_5_travel
		...
		<div class="row text-center" >		
			<div class = "col-md-6">
				...
				<div id="Mindanaoo"  style="display:none;" class="answer_list" >
					...
					<div class = "col-md-6" class="carousel-inner style="max-width:800px;>
							  <img class="mySlides active"    src="<?php echo base_url('img/regions/R1-Ph_fil_ilocos.png') ?>"    style="width:80%; border-radius: 70px 0px 97px 10px;">
							  <img class="mySlides"    src="<?php echo base_url('img/regions/R2-Ph_fil_cagayan_valley.png') ?>"    style="width:80%; border-radius: 70px 0px 97px 10px;">
							  <img class="mySlides"    src="<?php echo base_url('img/regions/R3-Ph_fil_central_luzon.png') ?>"    style="width:80%; border-radius: 70px 0px 97px 10px;">
							  <img class="mySlides"    src="<?php echo base_url('img/regions/R4-Ph_fil_calabarzon.png') ?>"    style="width:80%; border-radius: 70px 0px 97px 10px;">
							  
							  <img class="mySlides"    src="<?php echo base_url('img/regions/MIMAROPA-Ph_fil_mimaropa.png') ?>"    style="width:80%; border-radius: 70px 0px 97px 10px;">
							  <img class="mySlides"    src="<?php echo base_url('img/regions/R5-Ph_fil_bicol.png') ?>"    style="width:80%; border-radius: 70px 0px 97px 10px;">
							  <img class="mySlides"    src="<?php echo base_url('img/regions/R6-800px-Ph_fil_western_visayas.png') ?>"    style="width:80%; border-radius: 70px 0px 97px 10px;">
							  <img class="mySlides"    src="<?php echo base_url('img/regions/R7-800px-Ph_fil_central_visayas.png') ?>"    style="width:80%; border-radius: 70px 0px 97px 10px;">
							  
							  <img class="mySlides"    src="<?php echo base_url('img/regions/R8-Ph_fil_eastern_visayas.png') ?>"    style="width:80%; border-radius: 70px 0px 97px 10px;">
							  <img class="mySlides"    src="<?php echo base_url('img/regions/R9-Ph_fil_zamboanga_peninsula.png') ?>"    style="width:80%; border-radius: 70px 0px 97px 10px;">
							  <img class="mySlides"    src="<?php echo base_url('img/regions/R10-Ph_fil_northern_mindanao.png') ?>"    style="width:80%; border-radius: 70px 0px 97px 10px;">
							  <img class="mySlides"    src="<?php echo base_url('img/regions/R11-Ph_fil_davao_region.png') ?>"    style="width:80%; border-radius: 70px 0px 97px 10px;">
							  
							  <img class="mySlides"    src="<?php echo base_url('img/regions/R12-Ph_fil_soccsksargen.png') ?>"    style="width:80%; border-radius: 70px 0px 97px 10px;">
							  <img class="mySlides"    src="<?php echo base_url('img/regions/R13-Ph_fil_caraga.png') ?>"    style="width:80%; border-radius: 70px 0px 97px 10px;">
							  <img class="mySlides"    src="<?php echo base_url('img/regions/CAR-Ph_fil_car.png') ?>"    style="width:80%; border-radius: 70px 0px 97px 10px;">
							  <img class="mySlides"    src="<?php echo base_url('img/regions/ARMM-LASTPh_fil_armm.png') ?>"    style="width:80%; border-radius: 70px 0px 97px 10px;">  
							  <img class="mySlides"    src="<?php echo base_url('img/regions/NCR-Ph_fil_ncr.png') ?>"    style="width:80%; border-radius: 70px 0px 97px 10px;">
